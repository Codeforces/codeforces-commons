...
public class FileSystemByteCacheTest extends TestCase {
    ...
    public void testStoringOfValues() throws Exception {
        ...
        try {
            ...
            CacheTestUtil.determineOperationTime("FileSystemByteCacheTest.testStoringOfValues", () -> {
    ...
    public void testConcurrentStoringOfValues() throws Exception {
        ...
        try {
            ...
            CacheTestUtil.determineOperationTime("FileSystemByteCacheTest.testConcurrentStoringOfValues", () -> {
    ...
    private static void internalTestConcurrentStoringOfValuesWithLifetime(
        ...
        try {
            ...
            CacheTestUtil.determineOperationTime("FileSystemByteCacheTest.testConcurrentStoringOfValuesWithLifetime", () -> {
